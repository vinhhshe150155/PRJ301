        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <form action="admin-showControl" method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input value="${s.room_id}" name="room" type="text" class="form-control" id="room" placeholder="Name">
                  </div>
                  <div class="form-group">
                    <label for="name">Time</label>
                    <input value="${s.time}" name="time" type="text" class="form-control" id="room" placeholder="Name">
                  </div>
                </div>
                <!-- /.card-body -->
